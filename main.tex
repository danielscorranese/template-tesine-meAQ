...
% --- PRIMA PAGINA (Frontespizio e Abstract)
\begin{titlepage}
    \thispagestyle{plain}% mostra il numero di pagina anche sul frontespizio
    \begin{center}
        % Intestazione
        Corsi Accademici di Musica Elettronica / DCSL34 oppure DCPL34\\
        Conservatorio A. Casella, L'Aquila
        
        \vspace{0.2cm}
        
        % Titolo Tesina
        {\fontsize{14}{17}\selectfont \textbf{\uppercase{MODELLO DI REDAZIONE DELLE TESINE D'ESAME}}}\\
        di (nome e cognome)
...
\nocite{*} % per stampare tutta la bibliografia anche se non citata
